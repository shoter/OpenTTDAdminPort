...
namespace OpenTTDAdminPort.Tests.Networking
{
    public class AdminPortTcpClientShould : TestKit
    {
        ...
        public void BeAbleToSendMessage()
        {
            ...
            var actor = Sys.ActorOf(AdminPortTcpClient.Create(defaultServiceProvider, string.Empty, 0));
        ...
        public void SendReceivedMessageToParent()
        {
            ...
            IActorRef actor = probe.ChildActorOf(AdminPortTcpClient.Create(defaultServiceProvider, string.Empty, 0));
        ...
        public void Unsubscribing_NonExistingClient_ShouldNotCauseAnyException()
        {
            ...
            IActorRef actor = probe.ActorOf(AdminPortTcpClient.Create(defaultServiceProvider, string.Empty, 0));
