...
namespace OpenTTDAdminPort.Game
{
    ...
    {
        /// <summary>
        /// Represents day. Possible values - 1..31
        /// </summary>
        public byte Day { get; }

        /// <summary>
        /// Gets the month. Possible values - 0..1
        /// </summary>
        public byte Month { get; }

        /// <summary>
        /// Gets the year. Possible values - 0...
        /// </summary>
        ...
        public OttdDate(uint date)
        {
            ...
            if (rem >= (OttdDateHelper.DaysInYear * 100) + 25)
            {
                ...
                rem %= (OttdDateHelper.DaysInYear * 100) + 24;
            }
            ...
            while (rem >= OttdDateHelper.GetDaysInYear(year))
            {
                rem -= OttdDateHelper.GetDaysInYear(year);
                year++;
            }

            /* Skip the 29th of February in non-leap years */
            if (!OttdDateHelper.IsLeapYear(year) && rem >= OttdDateHelper.DaysTillMonth[2] - 1)
            {
                rem++;
            }
