...
{
    internal class AdminJoinSecureMessageTransformer : IMessageTransformer<AdminJoinMessage>
    {
        /// <summary>
        /// Gets the type of the supported message.
        /// </summary>
        public AdminMessageType SupportedMessageType => AdminMessageType.ADMIN_PACKET_ADMIN_JOIN_SECURE;
        ...
        public Packet Transform(in IAdminMessage message)
        {
            ...
            var msg = (AdminJoinSecureMessage)message;
